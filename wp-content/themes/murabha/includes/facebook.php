...
class tie_facebook_widget extends WP_Widget {
    ...
    public function widget($args, $instance) {
        ...
        <div class="facebook-box">
            <iframe src="<?php echo $protocol ?>://www.facebook.com/plugins/likebox.php?href=<?php echo $page_url ?>&amp;width=360&amp;height=250&amp;show_faces=true&amp;header=false&amp;stream=false&amp;show_border=false" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:360px; height:250px;" allowTransparency="true"></iframe>
        </div>
        <?php
        echo $after_widget;
    }
