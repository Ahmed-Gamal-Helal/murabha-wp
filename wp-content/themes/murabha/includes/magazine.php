...
class magazine_Widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            'magazine', // Base ID
            __('المجلات و الدوريات', 'text_domain'), // Name
            array('description' => __('عرض المجلات و الدوريات', 'text_domain'),) // Args
        );
    }
    ...
    public function form($instance)
    {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('عدد المجلات و الدوريات المعروض : ');
                ?></label>
