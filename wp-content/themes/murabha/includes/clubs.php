 ...
 */
class Clubs_Widget extends WP_Widget
{
    ...
    {
        parent::__construct(
            'andia_adabia', // Base ID
            __('الاندية الادبية', 'text_domain'), // Name
            array('description' => __('الاندية الادبية و روابطها', 'text_domain'),) // Args
        );
    }
    ...
    public function form($instance)
    {
        ...
        <p>
            ...
            ?>
            <label for="<?php echo $this->get_field_id('club1'); ?>"><?php _e('النادى 1'); ?></label>
        ...
        <p>
            ...
            ?>
            <label for="<?php echo $this->get_field_id('club2'); ?>"><?php _e('النادى 2'); ?></label>
        ...
        <p>
            ...
            ?>
            <label for="<?php echo $this->get_field_id('club3'); ?>"><?php _e('النادى 3'); ?></label>
        ...
        <p>
            ...
            ?>
            <label for="<?php echo $this->get_field_id('club4'); ?>"><?php _e('النادى 4'); ?></label>
        ...
        <p>
            ...
            ?>
            <label for="<?php echo $this->get_field_id('club5'); ?>"><?php _e('النادى 5'); ?></label>
        ...
        <p>
            ...
            ?>
            <label for="<?php echo $this->get_field_id('club6'); ?>"><?php _e('النادى 6'); ?></label>
        ...
        <p>
            ...
            ?>
            <label for="<?php echo $this->get_field_id('club7'); ?>"><?php _e('النادى 7'); ?></label>
        ...
        <p>
            ...
            ?>
            <label for="<?php echo $this->get_field_id('club8'); ?>"><?php _e('النادى 8'); ?></label>
...
function register_Clubs_Widget()
{
    register_widget('Clubs_Widget');
}

add_action('widgets_init', 'register_Clubs_Widget');