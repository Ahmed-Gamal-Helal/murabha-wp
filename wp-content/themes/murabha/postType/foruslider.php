...
function foruslider_custom_post() {
    $labels = array(
    ...
    register_post_type('foruslider', $args);
}

add_action('init', 'foruslider_custom_post');


add_action('cmb2_admin_init', 'cmb2_plan_metaboxes2');

/**
 * Define the metabox and field configurations.
 */
function cmb2_plan_metaboxes2() {
    ...
    $cmb = new_cmb2_box(array(
        ...
        'object_types' => array('foruslider'), // Post type
        'context' => 'normal',
        'priority' => 'high',
    ...
    $cmb->add_field(array(
        ...
        'id' => $prefix . 'link_foruslider',
        'attributes' => array('class' => 'link_foruslider'),
        'type' => 'text',
            // 'repeatable' => true,
    ));
